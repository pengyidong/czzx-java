...
import com.peng.note.dao.UserRoleDao;
...
public class UserRoleServiceImpl implements UserRoleService {
     ...
     */
    @Override
    public List<UserRole> queryById(String userId) {
    ...
    @Override
    public List<Integer> queryRoleList(String userId) {
        return userRoleDao. queryRoleList(userId);
    }

    @Override
    public Boolean deleteByUserId(String userId, Integer roleId) {
        return userRoleDao.deleteByUserId(userId, roleId) > 0;
    }
}
